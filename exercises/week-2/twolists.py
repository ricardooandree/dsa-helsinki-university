""" Description:
You are given two lists A and B both containing the numbers 1 ... n in some order. Your task is to count how many of the numbers 1 \dots n occur earlier on the list A than on the list B. 
