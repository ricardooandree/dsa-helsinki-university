""" Description:
Implement a test, where the numbers 1,2,...,n are added to the end of the list one at a time. Then the last element of the list is deleted n times.
...
# TODO Time for additions: s
# TODO Time for deletions: s
# TODO The code you used in the test: